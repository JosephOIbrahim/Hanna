...
| q016 | Octavius reachability — does Octavius exist as a runnable subprocess on Joe's Mac today? Replaces the Line C sandbox spike (which DIED on the FORUM because L1 verifier inaccessible from this Linux env). Asking Joe directly is the verifier; blocks L7 octavius_bridge design | high | open | none | 2026-05-25 |
